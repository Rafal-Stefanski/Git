...
public class Task {
    ...
    /**
     * 8. Utwórz program który będzie pobierał od użytkownika liczby typu float aż do momentu osiągnięcia limitu
     * podanego jako parametr metody. Na koniec wypisz ile było tych liczb,
