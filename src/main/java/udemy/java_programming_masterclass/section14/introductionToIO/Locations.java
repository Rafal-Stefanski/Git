...
public class Locations implements Map<Integer, Location> {
    ...
    public static void main(String[] args) throws IOException {
        try (DataOutputStream locFile = new DataOutputStream(new BufferedOutputStream(new FileOutputStream("src/main/java/udemy/java_programming_masterclass/section14/introductionToIO/locations.dat")));) {
    ...
    static {
        ...
        try (DataInputStream locFile = new DataInputStream(new BufferedInputStream((new FileInputStream("src/main/java/udemy/java_programming_masterclass/section14/introductionToIO/locations.dat"))))) {
            boolean eof = false;
            while (!eof) {
                try {
