...
public class Contacts_sample {
    private String name;
    private int phoneNumber;

    private ArrayList<String> contacts = new ArrayList<String>();

    public Contacts_sample(String name, int phoneNumber) {
        this.name = name;
    ...
    public static Contacts_sample addContact(String name, int phoneNumber) {
        return new Contacts_sample(name, phoneNumber);
    }
